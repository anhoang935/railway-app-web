                  ...
                  <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
                    {trainCoaches.map((coach, index) => (
                      <div
                        ...
                        className={`border rounded-lg p-4 cursor-pointer hover:shadow-md transition-all ${selectedCoach?.coachID === coach.coachID ? 'border-blue-500 bg-blue-50' : 'border-gray-200'
                          }`}
